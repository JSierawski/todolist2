...
ActiveRecord::Schema.define(version: 20170630141511) do
  ...
  add_index "to_do_items", ["todo_list_id"], name: "index_to_do_items_on_todo_list_id"
  ...
  create_table "todo_items_users", force: :cascade do |t|
    t.integer "user_id"
